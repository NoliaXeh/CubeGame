...
Entity::Entity(const Vector& pos)
    : pos_(posi), hitbox_(), model_(), visible_(false)
{}
Entity::Entity(const Vector& pos, const Hitbox& hitbox)
    : pos_(pos), hitbox_(hitbox), model_(), visible_(false)
{}
Entity::Entity(const Vector& pos, const Hitbox& hitbox, const Model& model)
...
void Entity::set_pos(const Vetcor3& pos)
{
    pos_ = pos;
}
void Entity::set_hitbox(const Hitbox3& hitbox)
{
    hitbox_ = hitbox;
}
